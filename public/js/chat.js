...
window.onload = function()
{
    ...
    .then( () => {
        axios.get(`/chat/${chatId}/getUsers`).then(res => {
        ...
        .then( () => {
            axios.get(`/chat/${chatId}/getMessages`).then(res => {
                appendMessages(res.data.messages);
            })
        })
        .then( () => {
            // Laravel Echo
            // Laravel Echo send messages to other clients, not to yourself
            ...
            .listenForWhisper('typing', e => {
                ...
                // After 3000 ms the 'está escribiendo' disappears
